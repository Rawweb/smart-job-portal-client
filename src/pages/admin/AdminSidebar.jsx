  ...
  return (
    <>
        ...
        <div className='h-16 flex items-center px-6 border-b border-border'>
          <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col'>
              <span className='font-bold text-sm leading-tight text-text-heading'>
                SkillBridge
              </span>
      ...
      <Modal
        ...
        title='Sign out?'
        description='You will be returned to the login page and will need to sign in again to access the admin panel.'
