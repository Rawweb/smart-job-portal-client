...
const navLinks = [
  ...
  { to: '/graduate/jobs', label: 'Browse Jobs', icon: Briefcase },
  { to: '/graduate/applications', label: 'My Applications', icon: FileText },
  { to: '/graduate/profile', label: 'Profile', icon: User },
];

const GraduateSidebar = ({ closeMenu }) => {
